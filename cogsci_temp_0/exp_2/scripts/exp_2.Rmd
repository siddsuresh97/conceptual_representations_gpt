...
# feature list humans (leuven) vs triplet humans
...
triplet_cosine_dist = 1-  lsa::cosine(t(data.matrix(human_triplet_mds[,3:5])))
rownames(triplet_cosine_dist) <- human_triplet_mds$concept

# proc between human feature listing(leuven) and human triplet(us)
exp_1_proc <- protest(leuven_mds, human_triplet_mds[3:5])
print('cosine proc')
